                ...
                when (pacman.facing) {
                    RIGHT -> {
                        when {
                            ...
                            with(currSide.neighbors.right) {Vertex(cols.first, rows.elementAt(currSide.rows.indexOf(pacman.y))) !in walls } -> {
                    ...
                    LEFT -> {
                        when {
                            ...
                            with(currSide.neighbors.left) {Vertex(cols.last, rows.elementAt(currSide.rows.indexOf(pacman.y))) !in walls } -> {
                    ...
                    UP -> {
                        when {
                            ...
                            with(currSide.neighbors.up) {Vertex(cols.elementAt(currSide.cols.indexOf(pacman.x)), rows.last) !in walls } -> {
